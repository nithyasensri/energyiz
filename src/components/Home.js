...
import Contactus from './All-Component/Contactus';


import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import {
    faSquareCheck, faHandshake, faLightbulb, faCalendarCheck,faArrowUp
...
import banner from '../assets/5016826_Windmill_Wind_3840x2160.mp4'

import data1 from '../assets/7rpoibg1-trustmark.jpg'
import data2 from '../assets/8x4swkmi-scottishpower.jpg'
import data3 from '../assets/zcp7yuzh-retrofit.jpg'
import data4 from '../assets/t6qtjac8-mcs-certified-logo-e1632836488843.png'
import data5 from '../assets/bab-logo.png'

import izenergy from '../assets/img_8479.jpeg'
const Home = () => {
    const settings = {
        dots: true,
        infinite: true,
    ...
    const scrollToTop = () => {
        let scrollInterval = setInterval(() => {
            ...
            if (currentScroll > 0) {
              window.scrollTo({
                top: currentScroll - 50, // Adjust this value to control scroll speed
                behavior: 'smooth',
              });
            } else {
              clearInterval(scrollInterval); // Stop the interval when the top is reached
            }
          }, 10); //
      };
    ...
    const data = [
        {
            image: data1,
            title: "7rpoibg1-trustmark.jpg",
            link: "7rpoibg1-trustmark.jpg"
        },
        {
            image: data2,
            title: "7rpoibg1-trustmark.jpg",
    ...
    return (
        ...
        <div style={{ "padding": "0px" }}>
            <Row className="justify-content-center">
                <Col md={12}>
                    ...
                    <div className='outer-overlay'>
                        <div class="mwt-elementor-main-slider-top-corners-left fast"></div>
                        <div class="mwt-elementor-main-slider-top-corners-right fast"></div>
                        <div className="overlay">
                            <p className="overlay-title">
                                <b>
                                    Optimising Home Energy Efficiency
                                </b>
                            </p>
                            <h1>
                                <b>
                                    Making Your Home More Energy Efficient</b>
                            </h1>
                            <p className="overlay-subtitle">
                                We excel in installing energy-efficient solutions that deliver both comfort and savings directly to your home. Our goal is to lead the charge toward a more environmentally friendly and
                                economically efficient future for everyone.
                            </p>
                        </div>
                        <div class="mwt-elementor-main-slider-bottom-corners-left fast"></div>
                        <div class="mwt-elementor-main-slider-bottom-corners-right fast"></div>
                    </div>
                </Col>
            </Row>
            <Row >
                <Col md={12} style={{ "background": "#F5F5F5" }}>
                    <Row className="justify-content-center">
                                        ...
                                        <Col md={3} className='iz-left'>
                                            <svg width="60" height="60" viewBox="0 0 60 60" fill="rgb(0,185,214)" xmlns="http://www.w3.org/2000/svg">
                                                <g clip-path="url(#clip0_41_298)">
                                                    ...
                                                    <path d="M33.5156 38.7891H26.4844C25.5136 38.7891 24.7266 39.5761 24.7266 40.5469V47.5781C24.7266 48.5489 25.5136 49.3359 26.4844 49.3359H33.5156C34.4864 49.3359 35.2734 48.5489 35.2734 47.5781V40.5469C35.2734 39.5761 34.4864 38.7891 33.5156 38.7891ZM31.7578 45.8203H28.2422V42.3047H31.7578V45.8203Z" fill="#90c370"></path>
            ...
            <Row>
                <Col md={12} className='image-background'>
                    <Row className="justify-content-center">
                        <Col md={9} className="our-services">
                            <h3>Our Services</h3>
                            <Col md={12}>
                                <Row>
                                    <Col md={4} >
                                        <div className='service-div'>
                                            ...
                                            <div className='smallcontent'>
                                                <h4>Renewable</h4>
                                                <p>Powering your home's energy</p>
                                    ...
                                    <Col md={4}>
                                        <div className='service-div'>
                                            <div className='small-img'>
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style={{ fill: "rgb(255,255,255)" }} height="50" width="50"><path d="M0 128V352c0 70.7 57.3 128 128 128H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H128c-35.3 0-64-28.7-64-64s28.7-64 64-64H368c8.8 0 16 7.2 16 16s-7.2 16-16 16H128c-17.7 0-32 14.3-32 32s14.3 32 32 32H368c44.2 0 80-35.8 80-80V128c0-53-43-96-96-96H96C43 32 0 75 0 128z"></path></svg>
                                            </div>
                                            <div className='smallcontent'>
                                                <h4>Insulation</h4>
                                                <p>Your home's shield against energy loss</p>
                                                <ul className='renew-list'>
                                                    <li>
                                                        <span><FontAwesomeIcon icon={faSquareCheck} /></span>
                                                        Wall Insulation
                            ...
                            <Row>
                                <Col md={4} >
                                    <div className='custom-div'>
                                        <div className='cus-small'>
                                            <FontAwesomeIcon icon={faHandshake} />
                                        </div>
                                        <h3>Customer</h3>
                                        <div className='mypine'></div>
                                        <h4>9000</h4>
                                    </div>
                                </Col>
                                <Col md={4} >
